...
logger = logging.getLogger("finsignal.quant.datasets.dolthub")
...
#: page, not more attempts. `FINSIGNAL_DOLT_PAGE_SIZE` sets it without a code
...
SAFE_PAGE_SIZE = max(50, min(ROW_LIMIT, int(os.getenv("FINSIGNAL_DOLT_PAGE_SIZE", ROW_LIMIT))))
...
_USER_AGENT = "FinSignal-Research/1.0 (quantitative research; contact via repository)"
